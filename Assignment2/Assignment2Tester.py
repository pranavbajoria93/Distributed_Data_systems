...
if __name__ == '__main__':
    try:
        ...
        con = Assignment1.getOpenConnection(dbname='ddsassignment2');
        ...
        Assignment2.RangeQuery(1.0, 3.0, con, "./rangeResult.txt");


        # Calling PointQuery
        print("Performing Point Query")
        Assignment2.PointQuery(1.5, con, "./pointResult.txt");
